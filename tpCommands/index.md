...
| !findclaim \[検索ワード\] | 割り当てられているモジュールから検索する |
| !findview \[検索ワード\] | 表示されているモジュールから検索する |
...
| !call | キューのコマンドを一つ実行する |
| !call \[名前\] | キューの名前付きコマンドを実行する |
| !callall | 名前付きコマンドを含めたすべてのキューのコマンドを実行する |
| !callset \[数\] | キューのコマンドの実行に必要なコールを実行するユーザー数を変更する |
| !callcount | コールしたユーザー数を表示する |
| !uncall | コールを取り消す |
| !callplayers | コールしたプレイヤーを表示する |
| !callnow | 要求コール数を無視してキューのコマンドを実行する |
